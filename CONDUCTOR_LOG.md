...
- RESUME: continue M-2 from #5 THE FORMATION-READ.
- Files: dressing-room/manager/system.md (#1+#2+#3+#4 locked · pending markers #5–#11 in header comment). Commit #3: 50c7b29 · Commit #4: <hash on push>.
