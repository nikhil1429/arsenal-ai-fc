...
- RESUME: continue M-2 from #4 THE RECONCILIATION.
- Files: dressing-room/manager/system.md (#1+#2+#3 locked · pending markers #4–#11 in header comment). Commit #3: <hash on push>.
