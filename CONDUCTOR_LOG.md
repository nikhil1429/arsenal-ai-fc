...
- LOCKED + committed this thread: #1 IDENTITY (two-brain anchor-model + backdrop + #14 bond) · #2 THE INVIOLABLE LAW (6 laws — no-invented-number[+wrapper-validated] · Governor-absolute[RED cancels · convergence-not-hours · akathisia hard-block · no med-interpretation] · 3 honesty-overrides · canon-fidelity/no-fabricated-quotes · no-calendar-pressure · scope).
...
- RESUME: continue M-2 from #3 HOW YOU THINK EACH MORNING.
- Files: dressing-room/manager/system.md (created — #1+#2 + pending markers). Commit: <hash on push>.
