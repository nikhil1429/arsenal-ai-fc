...
$names = @("ArsenalFC-Thalamus","ArsenalFC-Cortex","ArsenalFC-Tone","ArsenalFC-Presence","ArsenalFC-DMN","ArsenalFC-Consolidate","ArsenalFC-HippoStore","ArsenalFC-HippoIndex","ArsenalFC-Examiner")
