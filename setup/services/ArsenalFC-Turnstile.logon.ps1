...
#
# turnstile IS A LOGON TASK AND NOT A SERVICE, ON PURPOSE:
#   it needs HIS interactive desktop session; session 0 cannot see it
...
$id   = "ArsenalFC-Turnstile"

$action    = New-ScheduledTaskAction -Execute "wscript.exe" `
             -Argument ("`"$repo\setup\hidden_run.vbs`" node scripts\turnstile.mjs") `
...
# ⛔ REGISTERED DISABLED — this is not a mistake.
