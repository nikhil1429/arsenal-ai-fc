...
| **THE HEARTBEAT** | one sensory pass: fsrs · calibration · nemesis · maidan | 4 organs built; pass is [LEAP] | **BUILT** — `heartbeat.mjs` → `pulse.json`; shells **8** organs, not 4 (read `heartbeat_config.json.order`) |
