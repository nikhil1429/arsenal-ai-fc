# /forge — REFERENCE (the full body of the skill as it stood on 22 Sep 2026, moved here VERBATIM — L9, never deleted)
> Since 22 Sep 2026 (his word, forks ruling row 242/243) SKILL.md is a short router: the boot is `node scripts/learn_digest.mjs`; this file is the canon the digest and the router POINT INTO by section name. Open the section a step needs — never the whole file. Nothing below was edited in the move.
