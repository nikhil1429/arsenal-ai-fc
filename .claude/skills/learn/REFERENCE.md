# /learn — REFERENCE (the full body of the skill as it stood before 22 Sep 2026, moved here VERBATIM — L9, never deleted)
> Since 22 Sep 2026 (his word, forks ruling row 242) SKILL.md is a short router: it runs `node scripts/learn_digest.mjs` and obeys that screen.
> This file is the canon the digest POINTS INTO by section name. Open the section a step needs — never the whole file. Nothing below was edited in the move.
