...
2. CAPTAIN'S BROWSER STEPS (machine-halves prepared; need his logins): Jules on the public repo (both Pro accounts ENROLLED — first task = the doc-number refresh for ORGANISM_ANATOMY/LEDGER) · the phone Voice-Gaffer Gem (gem_cartridge.md staged) · the Gemini-Pro Deep-Research surface (scout_pack.md prompts staged nightly). All are HUMAN surfaces — see the Pro-lane note.
